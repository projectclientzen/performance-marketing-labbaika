...
/**
 * Menghapus satu baris harga. Tidak ada pengecekan pemakaian: closing
 * menyimpan `price_at_transaction` sebagai angka pada barisnya sendiri, bukan
 * rujukan ke tabel harga — jadi menghapus harga tidak mengubah closing mana
 * pun yang sudah tercatat.
 */
export async function DELETE(request: Request, { params }: { params: Promise<{ id: string }> }) {
  ...
  if (error) {
    console.error("[api/programs/:id/prices] DELETE", error);
