    ...
    <div>
      ...
      <div className="flex items-center gap-2">
        <button
          ...
          className="flex h-11 w-11 shrink-0 items-center justify-center rounded-lg border border-line bg-card text-lg font-medium text-ink-900 disabled:opacity-40"
        >
          −
        </button>
        <input
          ...
          className="h-11 w-full rounded-lg border border-line bg-card px-3 text-center font-mono text-base"
        />
        <button
          type="button"
          aria-label="Tambah"
